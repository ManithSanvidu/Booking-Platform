  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden md:block relative w-full flex-1">
        <img className="absolute inset-0 h-full w-full object-cover" src="https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&q=80&w=1500" alt="Festival stage" />
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/80 via-purple-900/40 to-transparent mix-blend-multiply" />
        <div className="absolute top-12 left-12 right-12 text-white">
          <h3 className="text-4xl font-bold mb-4">Join the Experience.</h3>
          <p className="text-lg font-medium text-white/80">Create an account to book tickets, manage reservations, and get notified about upcoming events.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:w-[480px] xl:w-[560px] mx-auto animate-fade-in-up">
        <div className="w-full max-w-sm mx-auto lg:w-96">
          ...
          <p className="mt-2 text-sm text-slate-500 font-medium">Your next great memory starts here.</p>
          ...
          <div className="mt-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="tel" className="input-field" placeholder="+1 (555) 000-0000" value={phone} onChange={e => setPhone(e.target.value)} required />
              </div>
              <div>
