...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'The service has been successfully created.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'The service has been successfully updated.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Service not found.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'The service has been successfully deleted.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Service not found.' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
